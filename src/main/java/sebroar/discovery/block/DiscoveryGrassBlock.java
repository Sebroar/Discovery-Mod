...
public class DiscoveryGrassBlock extends GrassBlock {
	protected final Supplier<Block> soilBlock;
	protected final boolean growsInDark;
	public DiscoveryGrassBlock(Properties properties, Supplier<Block> soilBlock, boolean growsInDark) {
		super(properties);
	...
	public boolean hasSufficientLight(BlockState grassState, World world, BlockPos grassPos) {
		...
		if (topBlock.getBlock() == Blocks.SNOW && topBlock.getValue(SnowBlock.LAYERS) == 1) return true;
